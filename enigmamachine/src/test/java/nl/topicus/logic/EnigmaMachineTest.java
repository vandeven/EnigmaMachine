...
public class EnigmaMachineTest {
	...
	public void testAddRotor(){
		IRotor rotor = new Rotor1('a');
		EnigmaMachineBuilder builder = new EnigmaMachineBuilder("").addRotor(rotor);
